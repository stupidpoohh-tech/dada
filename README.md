...
| `say_sent` | 개발자에게 한마디를 남겼다 | `kind`(hi·good·idea) |
...
처음에는 버튼 하나로 접어 두고, 펴면 세 줄짜리 폼(말·이름·답장받을곳)이 나왔다.
**나가는 길에 마주치기엔 너무 무거웠다** — 남길 마음이 있어도 세 칸을 보면 접는다.
지금은 접지 않고 그림 셋만 놓는다. 인사와 좋았어요는 **누르면 그대로 가고**,
「할 말 있어요」만 적는 칸을 편다 — 말이 있어야 뜻이 사는 하나뿐이라서다.
